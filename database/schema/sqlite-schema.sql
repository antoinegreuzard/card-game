...
CREATE TABLE IF NOT EXISTS "games"(
  ...
  "player2_id" integer,
  "status" varchar check("status" in('waiting', 'ready', 'finished')) not null default 'waiting',
  "created_at" datetime,
  "updated_at" datetime,
...
INSERT INTO migrations VALUES(9,'2024_11_15_081654_create_games_table',1);
INSERT INTO migrations VALUES(10,'2024_11_15_081715_create_cards_table',1);
